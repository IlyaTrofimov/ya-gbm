...
int main()
{
    ...
    WriteLine("Количество точек " + ToString((int)dataSet.size()), &log);
...
{  
    ...
    params.GradientShrinkage = 1.0;
    params.TreeHeight = 10;
    params.TreesTotal = 1;
    params.BaggingPart = 1.0;
    params.ThresholdsCount = 32;
    params.RSMPart = 1;
    params.Features = 0;
    params.StopByTestError = true;
    params.TestPart = 0.25;
    params.FilterErrors = 0;
    params.WeightTrimming = 0;
    params.MinLeafSize = 5;
    ...
    */
    ...
    params.Metrics[1] = (QualityChecker*)(new MSE(WeightType_Constant));

    //FIXME
    params.AllowedFeatures.resize(100, true);
    for (int i = 0; i < 10; ++i) 
